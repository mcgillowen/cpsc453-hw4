...
Scene * Scene::initTestScene(int N){
    ...
    Point normalDown = Point(0.0,-1.0,0.0);
    Point normalUp = Point(0.0,1.0,0.0);
    Point normalRight = Point(1.0,0.0,0.0);
    Point normalLeft = Point(-1.0,0.0,0.0);
    Point normalTowards = Point(0.0,0.0,-1.0);
    s1->setMaterial(sphere);
    ret->addObject(s1);
    // Add in bottom square
    Object * t1 = new Triangle(p1,p3,p2,normalUp);
    Object * t2 = new Triangle(p4,p2,p3,normalUp);
    ret->addObject(t1);
    ret->addObject(t2);
    t1->setMaterial(test);
    t2->setMaterial(test);
    // Add in top square
    t1 = new Triangle(p5,p7,p6,normalDown);
    t2 = new Triangle(p8,p7,p5,normalDown);
    t1->setMaterial(test);
    t2->setMaterial(test);

    // Add in left square
    t1 = new Triangle(p3,p1,p8,normalRight);
    t2 = new Triangle(p3,p8,p7,normalRight);
    t1->setMaterial(test);
    t2->setMaterial(test);
    ret->addObject(t1);
    ret->addObject(t2);
    ...
    // Add in back square
    t1 = new Triangle(p4,p3,p7,normalTowards);
    t2 = new Triangle(p4,p7,p6,normalTowards);
    t1->setMaterial(test);
    t2->setMaterial(test);
    ret->addObject(t1);
    ret->addObject(t2);
    ...
    // Add in right square
    t1 = new Triangle(p4,p2,p5,normalLeft);
    t2 = new Triangle(p4,p5,p6,normalLeft);
...
Scene * Scene::initTestScene2(int N){
    ...
    black->kr = 0.20;
    black->kd = 0.75;
    black->ambient = Color(0.1,0.1,0.1,1.0);
    black->diffuse = Color(0.1,0.1,0.1,1.0);
    black->specular = Color(0.8,0.8,0.8,1.0);

    Material * red = new Material();
    red->type = DIFFUSE;
    red->kr = 0.10;
    red->kd = 0.80;
    red->ambient = Color(1.0,0.0,0.0,1.0);
    red->diffuse = Color(1.0,0.0,0.0,1.0);;
    red->specular = Color(1.0,0.0,0.0,1.0);
    ...
    //Spheres
    Object * s1 = new Sphere(Point(400.0,130.0,160.0),50.0);
    s1->setMaterial(black);
    ret->addObject(s1);

    Object * s2 = new Sphere(Point(200.0,200.0,160.0),100.0);
    s2->setMaterial(sphere);
    ret->addObject(s2);

    Object * s3 = new Sphere(Point(300.0,400.0,400.0),80.0);
    ...
    // Add light sources
    ret->addLight(Point(185.0,1000.0,169.0));
    ret->addLight(Point(400.0,1000.0,320.0));
    ret->addLight(Point(250.0,250.0,250.0));
    //ret->addLight(Point(500.0,500.0,0.0));
    //ret->addLight(Point(50.0,50.0,0.0));
